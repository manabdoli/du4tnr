...
- formula:
  ...
  variable by concatenating the values of all variables used. @param
  useNA This is passed to [`table()`](https://rdrr.io/r/base/table.html)
  and can take these values: c("no", "ifany", "always"). The default
  value is "no".
